...
<head>
	...
	<meta charset="utf-8">
	<style type="text/css">
		body { color: gray; font-weight: bold; }
	</style>
</head>
<body>
<?php 
...
?>
<!-- Выводим форму, через которую пользователь будет запускать этот сценарий, и, возможно, отображаем сообщение об ошибке в случае, если $WasEroor != 0. -->
